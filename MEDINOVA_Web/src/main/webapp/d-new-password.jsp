...
<head>
<meta charset="UTF-8">
<title>Doctor New Password</title>
</head>
<body>
<%
		...
		<div class="container">
			<div class="text-center mx-auto mb-5" style="max-width: 500px;">
				<h5
					...
					Questions?</h5>
				<h1 class="display-4">Doctor New Password</h1>
			</div>
			<div class="row">
					...
					<%String email = (String)request.getAttribute("email"); %>
						<form action="" method="post">
							...
							<input type="hidden" name="email" value="<%=email%>">
								...
								<div class="col-12">
									<input type="password" class="form-control bg-light border-0"
										name="cnp" placeholder="Confirm New Password" style="height: 55px;">
								</div>

								<div class="col-12">
									<button class="btn btn-primary w-100 py-3" name="action"
										value="np" type="submit">New Password</button>
								</div>
							</div>
						</form>
					</div>
