    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            <div class="row">
             ...
             <div class="text-center mx-auto mb-5" style="max-width: 500px;">
             <%if(msg!=null){ %>
                <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5"><%out.print(msg); %></h5>
            	<%} %>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="bg-white rounded p-5 m-5 mb-0">
                        <form action="DoctorController" method="post" enctype="multipart/form-data">
                            <div class="row g-3">
                             	<div class="col-12">
                                    <input type="file" class="form-control bg-light border-0" name="image" placeholder="Your Photo" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                 ...
                                 <div class="col-12">
                                    <input type="text" class="form-control bg-light border-0" name="specialization" placeholder="Your Specilaization" style="height: 55px;">
                                </div>
                                 <div class="col-12">
                                    <input type="text" class="form-control bg-light border-0" name="w_address" placeholder="Your Work Address" style="height: 55px;">
                                </div>
                                <div class="col-12">
		...
		<div class="container">
			<div class="row g-5">
				...
				<div class="col-md-6 text-center text-md-end">
					<p class="mb-0">
						Designed by <a class="text-primary" href="https://htmlcodex.com">HTML
							Codex</a>
					</p>
				</div>
			</div>
