		...
		<div class="container">
			<div class="text-center mx-auto mb-5" style="max-width: 500px;">
				<h5
					...
					Questions?</h5>
				<h1 class="display-4">Patient Profile</h1>
			</div>
			<div class="row">
							...
							<div class="row g-3">
								<div class="col-12">
									<input type="hidden" class="form-control bg-light border-0"
										name="id" value="<%=p.getPid()%>" style="height: 55px;">
								</div>
								...
								<div class="col-12">
									<input type="text" class="form-control bg-light border-0"
										name="contact" value="<%=p.getContact()%>"
										style="height: 55px;">
								</div>
								<div class="col-12">
									<input type="text" class="form-control bg-light border-0"
										name="address" value="<%=p.getAddress()%>"
										style="height: 55px;">
								</div>
								...
								<div class="col-12">
									<input type="email" class="form-control bg-light border-0"
										name="email" value="<%=p.getEmail()%>" style="height: 55px;">
								</div>
