...
<body>
	...
	<div class="container-fluid py-5">
		<div class="container">
			...
			<div class="row g-5">
				<%List<Appointment> all_pending_app = AppointmentDao.getAllPendingAppoinements(pa.getP_id()); %>
				<%
				...
				<div class="col-xl-4 col-lg-6">
					<div class="bg-light rounded overflow-hidden">
						...
						<div class="d-flex justify-content-between border-top p-4">
							...
							<div class="d-flex align-items-center">
								<small class="ms-3"> <i class="bi bi-currency-rupee"></i>Rs.
									<%=pa.getP_amount() %></small>
							</div>
						</div>
						...
						<div class="d-flex justify-content-between border-top p-4">
							<div class="d-flex align-items-center">
								<a class="h3 d-block mb-3"
									href="AppointmentController?action=confirm&aid=<%=a.getAid()%>&email=<%=patient.getEmail()%>">Confirm</a>
							</div>
							<div class="d-flex align-items-center">
								<a class="h3 d-block mb-3"
									href="d-delete-package.jsp?pid=<%=pa.getP_id()%>">Reject</a>
							</div>
						</div>
