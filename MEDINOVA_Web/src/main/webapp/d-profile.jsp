				...
				<div class="col-lg-8">
					<div class="bg-white rounded p-5 m-5 mb-0">
						<form action="DoctorController" method="post"
							...
							<div class="row g-3">
								<div class="col-12">
									<input type="hidden" class="form-control bg-light border-0"
										name="did" value="<%=d.getDid()%>" style="height: 55px;">
								</div>
								<div class="col-12">
									<img src="img/<%=d.getImage()%>" height="100" width="100">
								</div>
								<div class="col-12">
									<input type="file" class="form-control bg-light border-0"
										name="image" value="<%=d.getImage()%>" style="height: 55px;">
								</div>
								<div class="col-12">
									<input type="text" class="form-control bg-light border-0"
										name="name" value="<%=d.getName()%>" style="height: 55px;">
								</div>
								<div class="col-12">
									<input type="text" class="form-control bg-light border-0"
										name="contact" value="<%=d.getContact()%>"
										style="height: 55px;">
								</div>
								<div class="col-12">
									<input type="text" class="form-control bg-light border-0"
										name="address" value="<%=d.getAddress()%>"
										style="height: 55px;">
								</div>
								<div class="col-12">
									<input type="text" class="form-control bg-light border-0"
										name="specialization" value="<%=d.getSpecialization()%>"
										style="height: 55px;">
								</div>
								<div class="col-12">
									<input type="text" class="form-control bg-light border-0"
										name="w_address" value="<%=d.getWork_address()%>"
										style="height: 55px;">
								</div>
								<div class="col-12">
									<input type="email" class="form-control bg-light border-0"
										name="email" value="<%=d.getEmail()%>" style="height: 55px;">
								</div>
