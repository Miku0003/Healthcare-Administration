	...
	<div class="container-fluid pt-5">
		<div class="container">
			<div class="text-center mx-auto mb-5" style="max-width: 500px;">
				<h5
					class="p-inline-block text-primary text-uppercase border-bottom border-5">Any
					Questions?</h5>
				<h1 class="display-4">Patient Change Password</h1>
			</div>
			<div class="row">
							...
							<div class="row g-3">
								<div class="col-12">
									<input type="hidden" class="form-control bg-light border-0"
										name="pid" value="<%=p.getPid()%>" style="height: 55px;">
								</div>
								<div class="col-12">
									<input type="password" class="form-control bg-light border-0"
										name="op" placeholder="Old Password" style="height: 55px;">
								</div>
								<div class="col-12">
									<input type="password" class="form-control bg-light border-0"
										name="np" placeholder="New Password" style="height: 55px;">
								</div>
								<div class="col-12">
									<input type="password" class="form-control bg-light border-0"
										name="cnp" placeholder="Confirm New Password"
										style="height: 55px;">
								</div>

								<div class="col-12">
									<button class="btn btn-primary w-100 py-3" name="action"
										value="cp" type="submit">Update</button>
								</div>
							</div>
						</form>
					</div>
