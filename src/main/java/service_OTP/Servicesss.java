...
public class Servicesss {
	public void sendMail(String emailid,int num){
		final String username  = "mikutechlover08@gmail.com";
		final String password  = "wvdqpictufexwhzg ";
...
//		587
	...
	public void sendMsg(String emailid,String msg){
		final String username  = "doctorfinder8@gmail.com";
		final String password  = "llnjdjfkfsnwjvkg";
